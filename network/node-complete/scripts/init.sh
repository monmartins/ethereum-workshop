...
geth --syncmode "full" --datadir /home/dev --bootnodes $( cat /home/bootnode/enode ) --networkid ${NETWORK_ID} --ws --ws.addr  0.0.0.0 --ws.port 8546 --ws.api db,eth,net,web3,personal --rpc  --rpcaddr 0.0.0.0 --rpcapi="db,eth,net,web3,personal,web3"
